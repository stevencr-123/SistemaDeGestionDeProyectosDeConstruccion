...
public class AdministradorWindown extends javax.swing.JFrame {
    ...
    if(btnContratar != null) {
        btnContratar.setBackground(Color.BLUE);
    } else {
        System.err.println("Error: btnContratar no fue inicializado");
    }
    }
...
try {
    ...
    try {
        ...
        switch (cargo.toUpperCase()) {
            case "OBRERO":
                persona = new model.Obrero(tipoIdentificacion, numeroIdentificacion, primerNombre, primerApellido, correo, salario);
                        break;
            ...
            case "FUNCIONARIO PUBLICO":
                persona = new FuncionarioPublico(tipoIdentificacion, numeroIdentificacion, primerNombre, primerApellido, correo, salario); 
                        break;
            case "PROMOTOR":
                persona = new model.Promotor(tipoIdentificacion, numeroIdentificacion, primerNombre, primerApellido, correo, salario);
                break;
            default:
